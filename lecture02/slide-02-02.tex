...
%------------------------------------------------
\section{第二节：从OS角度看RISC-V CPU } % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.4\linewidth]{computer-arch-app}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.4\linewidth]{abstract-of-system}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{hardware-software-interface}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.45\linewidth]{arch-os-relation}
		\caption{计算机系统$_{[CS-152 Berkeley]}$}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.6\linewidth]{mainstream-isas}
...
\begin{frame}
	...
	\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{rv-privil-arch}
	\caption{RISC-V特权架构}
	\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.45\linewidth]{riscv_pagetable}
		\caption{RISC-V虚拟内存}
	\end{figure}
