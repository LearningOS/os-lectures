...
\begin{frame}[plain,t]    
    ...
    \begin{figure}
        \centering
%        \includegraphics[width=0.7\linewidth]{Slab-Allocation}
        \caption{xxxx}
    \end{figure}
...
\begin{frame}[plain,t]    
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{slob}
        \caption{xxxx}
    \end{figure}
...
\begin{frame}[plain,t]    
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{slab}
        \caption{xxxx}
    \end{figure}
\end{frame}
%------------------------------------------------
...
\begin{frame}[plain,t]    
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{slub}
        \caption{xxxx}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
