...
%% figure
    \begin{figure}
    \includegraphics[width=0.4\linewidth]{figs/Lock‐set.png}
%    \caption{xxxx}
    \end{figure}
\end{frame}
%----------------------------------------------
...
Know which code region should maintain atomicity
    ...
    \begin{figure}
    \includegraphics[width=0.4\linewidth]{figs/atomicity.png}
%    \caption{xxxx}
    \end{figure}
...
%% figure
    \begin{figure}
    \includegraphics[width=0.4\linewidth]{xxfigs/interleaving-cases.pngxx}
%    \caption{xxxx}
    \end{figure}
\end{frame}
%----------------------------------------------
