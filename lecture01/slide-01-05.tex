...
\frametitle{UNIX家族}
	...
	\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{unix-family}
	\caption{UNIX家族}
\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{unix-history}
		\caption{UNIX历史}
	\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{macos-family}
		\caption{MacOS家族}
	\end{figure}
...
%	\begin{figure}
%		\centering
		\includegraphics[width=0.8\linewidth]{macos-family-history}
%		\caption{MacOS家族}
%	\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.9\linewidth]{hongmeng-os-intro}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{fuchsia-os-intro}
