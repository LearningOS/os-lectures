...
\end{itemize}
	...
	\begin{figure}
	\centering
	\includegraphics[width=0.55\linewidth]{history-single-user-system}
	\caption{单用户系统}
\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.5\linewidth]{history-batch-processing}
		\caption{批处理系统}
	\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.65\linewidth]{history-multiprogramming}
		\caption{多道程序处理流程}
	\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.55\linewidth]{history-ds}
		\caption{分布式系统}
	\end{figure}
...
\begin{frame}[plain]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.55\linewidth]{history-aiot}
		\caption{AIoT系统}
	\end{figure}
