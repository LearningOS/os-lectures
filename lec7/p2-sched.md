...
<!-- 
请给出操作系统调度算法中关于的吞吐量的定义？

在操作系统中，吞吐量（throughput）是指系统每小时完成的作业数量。在考虑所有因素后，每小时完成50个作业比每小时完成40个作业更好¹。在调度算法中，吞吐量是一个重要的评价指标之一，它表示单位时间内CPU完成作业的数量。不同的调度算法和方式会对系统的吞吐量产生较大的影响²。

源: 2023/4/10(1) 调度简介，调度算法分类，调度算法的目标 - CSDN博客. https://blog.csdn.net/qq_22238021/article/details/80170495 访问时间 2023/4/10.
(2) 浅谈操作系统原理，处理器调度基本准则和实现 - 知乎. https://zhuanlan.zhihu.com/p/447737355 访问时间 2023/4/10.
(3) 操作系统之调度算法评价指标 (十二) --- 利用率、系统 .... https://blog.csdn.net/qq_19018277/article/details/98738492 访问时间 2023/4/10.
(4) 操作系统——进程调度算法 - 掘金. https://juejin.cn/post/7025631545327091719 访问时间 2023/4/10. -->
