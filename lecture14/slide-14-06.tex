...
\title[第1讲]{第十四讲 ：信号量与管程} % The short title appears at the bottom of every slide, the full title is only on the title page
...
% 
%----------------------------------------------
\subsection{内存屏障} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
%----------------------------------------------
\begin{frame}[fragile]
...
%% figure
    \begin{figure}
    \includegraphics[width=0.8\linewidth]{figs/demo-condvar.png}
%    \caption{xxxx}
    \end{figure}
