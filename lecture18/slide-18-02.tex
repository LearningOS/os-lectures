...
\begin{frame}[fragile]
	...
	%% figure
	\begin{figure}
		\includegraphics[width=1.0\linewidth]{linux-allfs}
		% \caption{xxxx}
	\end{figure}
...
\begin{frame}[fragile]
	...
	% from https://opensource.com/article/17/5/introduction-ext4-filesystem
	\centering
    \includegraphics[width=.7\textwidth]{ext2-3-indirect-block}
...
\begin{frame}[fragile]
	...
	%		\centering
	%	\Large
	\begin{columns}磁盘可以在内部执行调度并以任何顺序完成小部分的大写入
		\begin{column}{.5\textwidth}
			EXT4: 恢复异常文件系统 for crash-consistency problem
