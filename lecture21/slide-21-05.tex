...
% 
%         \item A simple implementation of that queue could be a mutex-protected [`VecDeque`\href{https://doc.rust-lang.org/stable/alloc/collections/vec_deque/struct.VecDeque.html)
%     	\begin{itemize}
%     	    \item Using mutexes in interrupt handlers is not a good idea since it can easily lead to deadlocks.
%     	\end{itemize}
% 
%         \item Example: https://github.com/phil-opp/blog_os/blob/post-12/src/task/keyboard.rs
%     \end{itemize}
% 
\end{frame}
%----------------------------------------------
...
% %% itemize
%     \begin{itemize}
%         \item [Finished Example\href{https://cfsamson.github.io/books-futures-explained/8_finished_example.html#our-finished-code)
%     \end{itemize}
\end{frame}
%----------------------------------------------
\end{document}
