...
%% itemize
    \begin{itemize}
        \item Languages like C\#, JavaScript, Java, GO and many others comes with a standard runtime for handling concurrency
        \item Rust uses a special library for handling concurrency
