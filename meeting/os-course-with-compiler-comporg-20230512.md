...
## - 需要学生掌握的核心点
 ...
 - 用一个project(甚至一个程序)来实践编译/操统/计组
 - 简化的编译/操统/计组的核心关联知识
   - 编译：高级语言 --> 汇编语言  --> 机器语言
   - 计组：机器语言 --> 特权级指令：数据处理/CPU控制 
   - 操统：高级语言 --> 特权级指令：控制CPU/处理中断
   - 一个高级语言编写的程序如何编译&加载&运行
...
- 初步构想 
  - 一个简化C语言的编译器设计：定义高级语言
    ...
    - 高级：C语言的子集，可支持指针和函数，和编译为RISC-V机器语言
