...
%    \framesubtitle{xxxx}
	...
	\includegraphics[width=1.\textwidth]{redhat-fd}
...
\begin{frame}[fragile]
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			...
			\item 某些机制已经很少使用
			\end{itemize}			
			\includegraphics[width=.8\textwidth]{normal-ipc}
...
\begin{frame}[fragile]
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			...
			\includegraphics[width=1.\textwidth]{dbus-simple}
...
\begin{frame}[plain]
	...
	\centering
				\includegraphics[width=.75\textwidth]{dbus-diagram}
